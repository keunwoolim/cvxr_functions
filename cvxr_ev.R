...
ev_problem <- function(.x, type = c("minrisk","optimal"),
...
cvxr_solution <- ev_problem(.x, type = c("minrisk","optimal")[1], 
                                 expected_reward = colMeans(.x) * 10000,
                                 lower = rep(-0.8, ncol(.x)), 
                                 upper = rep(0.8, ncol(.x)), 
                                 target = 2,
                                 budget = NULL, leverage = 1, solver = "OSQP")
...
cvxr_solution <- ev_problem(.x, type = c("minrisk","optimal")[1], 
                                 ...
                                 upper = rep(0.8, ncol(.x)), 
                                 target = 2,
                                 budget = 1, leverage = NULL, solver = "OSQP")
